...
- Aspose Cloud API credentials -- get them free at [dashboard.aspose.cloud](https://dashboard.aspose.cloud/applications). After registration, you’ll receive **150 free API requests per month**  
